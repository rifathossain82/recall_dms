...
Color kGreyLightPro = const Color(0xFFB4B4B4);
Color kGreyLightProMax = const Color(0xFFD0D0D0);
...
Color kBottomNavBarShadowColor = const Color(0xFFFFC220).withOpacity(0.10);
